...
import { DYNAMIC_FORM_CONTROL_INPUT_TYPE_NUMBER, DYNAMIC_FORM_CONTROL_TYPE_ARRAY, DYNAMIC_FORM_CONTROL_TYPE_CHECKBOX, DYNAMIC_FORM_CONTROL_TYPE_CHECKBOX_GROUP, DYNAMIC_FORM_CONTROL_TYPE_COLORPICKER, DYNAMIC_FORM_CONTROL_TYPE_DATEPICKER, DYNAMIC_FORM_CONTROL_TYPE_EDITOR, DYNAMIC_FORM_CONTROL_TYPE_GROUP, DYNAMIC_FORM_CONTROL_TYPE_INPUT, DYNAMIC_FORM_CONTROL_TYPE_RADIO_GROUP, DYNAMIC_FORM_CONTROL_TYPE_RATING, DYNAMIC_FORM_CONTROL_TYPE_SELECT, DYNAMIC_FORM_CONTROL_TYPE_SLIDER, DYNAMIC_FORM_CONTROL_TYPE_SWITCH, DYNAMIC_FORM_CONTROL_TYPE_TEXTAREA, DYNAMIC_FORM_CONTROL_TYPE_TIMEPICKER, DynamicFormComponent, DynamicFormControlComponent, DynamicFormLayoutService, DynamicFormService, DynamicFormValidationService, DynamicFormsCoreModule, DynamicTemplateDirective } from '@ng-dynamic-forms/core';
import { AutoComplete, AutoCompleteModule, CalendarModule, CheckboxModule, Chips, ChipsModule, ColorPickerModule, Dropdown, DropdownModule, EditorModule, InputMaskModule, InputSwitchModule, InputTextModule, InputTextareaModule, MultiSelectModule, RadioButtonModule, RatingModule, SliderModule, SpinnerModule } from 'primeng/primeng';
...
var DynamicPrimeNGFormControlComponent = /** @class */ (function (_super) {
    ...
    DynamicPrimeNGFormControlComponent.propDecorators = {
        ...
        "pViewChild": [{ type: ViewChild, args: [PRIME_NG_VIEW_CHILD_SELECTOR,] },],
    };
...
var DynamicPrimeNGFormComponent = /** @class */ (function (_super) {
    ...
    DynamicPrimeNGFormComponent.propDecorators = {
        ...
        "components": [{ type: ViewChildren, args: [DynamicPrimeNGFormControlComponent,] },],
    };
...
export { DynamicPrimeNGFormComponent, PrimeNGFormControlType, PRIME_NG_VIEW_CHILD_SELECTOR, PRIME_NG_AUTOCOMPLETE_TEMPLATE_DIRECTIVES, PRIME_NG_CHIPS_TEMPLATE_DIRECTIVES, PRIME_NG_DROPDOWN_LIST_TEMPLATE_DIRECTIVES, DynamicPrimeNGFormControlComponent, DynamicFormsPrimeNGUIModule };
//# sourceMappingURL=ui-primeng.es.js.map
